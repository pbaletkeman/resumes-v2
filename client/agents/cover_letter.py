    ...
    async def _try_llm(
        ...
        *,
        ...
        prompt = (
            ...
            "- Do not use any Unicode characters outside the standard ASCII range.\n"
            "- Do not fabricate the candidate's achievements. Only use achievements explicitly present in the resume.\n"
            "- Do not fabricate the company name, only use the exact company name from the job description.\n"
