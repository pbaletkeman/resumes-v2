...
tests/
  ...
  test_pipeline.py                 # AgentRunner / run_resume_pipeline orchestration + template passthrough + CLI/web persisted-override alignment (29 tests, stub agents)
