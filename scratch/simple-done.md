...
- [Completed Phases](#completed-phases)
  - [Phase 1 - Foundation: config, logging, errors, LLM clients, JSON utils  ✅ COMPLETED](#phase-1---foundation-config-logging-errors-llm-clients-json-utils---completed)
    - [Phase 1 Completion record](#phase-1-completion-record)
  - [Phase 2 - Pydantic models \& coercion  ✅ COMPLETED](#phase-2---pydantic-models--coercion---completed)
    - [Phase 2 Completion record](#phase-2-completion-record)
  - [Phase 3 - Parsing agents \& the format detector  ✅ COMPLETED](#phase-3---parsing-agents--the-format-detector---completed)
    - [Completion record](#completion-record)
  - [Phase 4 - LLM-only agents: Gap Analysis, ATS Compliance, Tone Polishing + shared validation cleanup  ✅ COMPLETED](#phase-4---llm-only-agents-gap-analysis-ats-compliance-tone-polishing--shared-validation-cleanup---completed)
    - [Phase 4 Completion record](#phase-4-completion-record)
  - [Phase 4 - Completed sub-task 4.1: shared `load_json_safe` helper](#phase-4---completed-sub-task-41-shared-load_json_safe-helper)
    - [Completion record](#completion-record-1)
  - [Phase 4 - Completed sub-task 4.2: standardize the multi-exception `except` sites](#phase-4---completed-sub-task-42-standardize-the-multi-exception-except-sites)
    - [Resolution (toolchain conflict)](#resolution-toolchain-conflict)
    - [Completion record](#completion-record-2)
  - [Phase 4 - Completed sub-task 4.3: `gap_analysis.py` `_try_llm` scaffolding dedupe](#phase-4---completed-sub-task-43-gap_analysispy-_try_llm-scaffolding-dedupe)
    - [Completion record](#completion-record-3)
  - [Phase 4 - Completed sub-task 4.4: `ats_compliance.py` shared scaffolding + `load_json_safe` routing](#phase-4---completed-sub-task-44-ats_compliancepy-shared-scaffolding--load_json_safe-routing)
    - [Completion record](#completion-record-4)
  - [Phase 4 - Completed sub-task 4.5: `tone_polishing.py` shared scaffolding + coercion/docstring clarity](#phase-4---completed-sub-task-45-tone_polishingpy-shared-scaffolding--coerciondocstring-clarity)
    - [Completion record](#completion-record-5)
  - [Phase 5 - Completed sub-task 5.1: re-order `resume_rewrite.py` (class first, helpers grouped)](#phase-5---completed-sub-task-51-re-order-resume_rewritepy-class-first-helpers-grouped)
    - [Completion record](#completion-record-6)
  - [Phase 5 - Completed sub-task 5.2: route validation guards through `load_json_safe`](#phase-5---completed-sub-task-52-route-validation-guards-through-load_json_safe)
    - [Completion record](#completion-record-7)
  - [Phase 5 - Completed sub-task 5.3: full `Args:`/`Returns:` + "why" on every post-validation helper](#phase-5---completed-sub-task-53-full-argsreturns--why-on-every-post-validation-helper)
    - [Completion record](#completion-record-8)
  - [Phase 5 - Completed sub-task 5.4: extract named skill-match helpers from `_skill_matches`](#phase-5---completed-sub-task-54-extract-named-skill-match-helpers-from-_skill_matches)
    - [Completion record](#completion-record-9)
  - [Phase 5 - Completed sub-task 5.5: `model_copy` never-mutate contract + `_tailor_skills` step-by-step](#phase-5---completed-sub-task-55-model_copy-never-mutate-contract--_tailor_skills-step-by-step)
    - [Completion record](#completion-record-10)
  - [Phase 5 - Completed sub-task 5.6: module docstring correctness story](#phase-5---completed-sub-task-56-module-docstring-correctness-story)
    - [Completion record](#completion-record-11)
  - [Phase 5 - Resume Rewrite agent + post-validation  ✅ COMPLETED](#phase-5---resume-rewrite-agent--post-validation---completed)
    - [Phase 5 Completion record](#phase-5-completion-record)
  - [Phase 6 - Completed sub-task 6.1: `cover_letter.py` banner sections (class first, helpers grouped)](#phase-6---completed-sub-task-61-cover_letterpy-banner-sections-class-first-helpers-grouped)
    - [Completion record](#completion-record-12)
  - [Phase 6 - Completed sub-task 6.2: route the seven `json.loads` guards through `load_json_safe`](#phase-6---completed-sub-task-62-route-the-seven-jsonloads-guards-through-load_json_safe)
    - [Completion record](#completion-record-13)
  - [Phase 6 - Completed sub-task 6.3: named-step comments inside the long `run`/`_try_llm` methods](#phase-6---completed-sub-task-63-named-step-comments-inside-the-long-run_try_llm-methods)
    - [Completion record](#completion-record-14)
  - [Phase 6 - Completed sub-task 6.4: standardize placeholder-token handling](#phase-6---completed-sub-task-64-standardize-placeholder-token-handling)
    - [Completion record](#completion-record-15)
  - [Phase 6 - Completed sub-task 6.5: module docstring covering the agent contract](#phase-6---completed-sub-task-65-module-docstring-covering-the-agent-contract)
    - [Completion record](#completion-record-16)
  - [Phase 6 - Cover Letter agent (largest file)  ✅ COMPLETED](#phase-6---cover-letter-agent-largest-file---completed)
    - [Phase 6 Completion record](#phase-6-completion-record)
  - [Phase 7 - Completed sub-task 7.1: fix stale renderer.py header](#phase-7---completed-sub-task-71-fix-stale-rendererpy-header)
    - [Completion record](#completion-record-17)
  - [Phase 7 - Completed sub-task 7.2: document the two rendering paths](#phase-7---completed-sub-task-72-document-the-two-rendering-paths)
    - [Completion record](#completion-record-18)
  - [Phase 7 - Completed sub-task 7.3: extract shared `_render` helper](#phase-7---completed-sub-task-73-extract-shared-_render-helper)
    - [Completion record](#completion-record-19)
  - [Phase 7 - Completed sub-task 7.4: docstring per template dict](#phase-7---completed-sub-task-74-docstring-per-template-dict)
    - [Completion record](#completion-record-20)
  - [Phase 7 - Completed sub-task 7.5: full class/method docstrings + `Raises:` on `render_all`](#phase-7---completed-sub-task-75-full-classmethod-docstrings--raises-on-render_all)
    - [Completion record](#completion-record-21)
  - [Phase 7 - Renderer, templates, formatter  ✅ COMPLETED](#phase-7---renderer-templates-formatter---completed)
    - [Phase 7 Completion record](#phase-7-completion-record)
  - [Phase 8 - Completed sub-task 8.1: step-by-step internal lookup](#phase-8---completed-sub-task-81-step-by-step-internal-lookup)
    - [Completion record](#completion-record-22)
  - [Phase 8 - Completed sub-task 8.2: rename ambiguous locals + docstring coverage](#phase-8---completed-sub-task-82-rename-ambiguous-locals--docstring-coverage)
    - [Completion record](#completion-record-23)
  - [Phase 8 - Completed sub-task 8.3: module docstring + taxonomy doc cross-check](#phase-8---completed-sub-task-83-module-docstring--taxonomy-doc-cross-check)
    - [Completion record](#completion-record-24)
  - [Phase 8 - Skill taxonomy \& normalization  ✅ COMPLETED](#phase-8---skill-taxonomy--normalization---completed)
    - [Phase 8 Completion record](#phase-8-completion-record)
  - [Phase 9 - Completed sub-task 9.1: extract `_run_stage` helper](#phase-9---completed-sub-task-91-extract-_run_stage-helper)
    - [Completion record](#completion-record-25)
  - [Phase 9 - Completed sub-task 9.2: convert seven blocks to `_run_stage` calls](#phase-9---completed-sub-task-92-convert-seven-blocks-to-_run_stage-calls)
    - [Completion record](#completion-record-26)
  - [Phase 9 - Completed sub-task 9.3: `run_agent_async` + `PipelineAgent` docs](#phase-9---completed-sub-task-93-run_agent_async--pipelineagent-docs)
    - [Completion record](#completion-record-27)
  - [Phase 9 - Completed sub-task 9.4: module docstring stage table + CLI steps](#phase-9---completed-sub-task-94-module-docstring-stage-table--cli-steps)
    - [Completion record](#completion-record-28)
  - [Phase 9 - Completed sub-task 9.5: guardrails + CLI smoke](#phase-9---completed-sub-task-95-guardrails--cli-smoke)
    - [Completion record](#completion-record-29)
  - [Phase 10 - Completed sub-task 10.1: `main.py` module docstring + listing parallel](#phase-10---completed-sub-task-101-mainpy-module-docstring--listing-parallel)
    - [Completion record](#completion-record-30)
  - [Phase 10 - Completed sub-task 10.2: `_read_text_input` dedupe + helper docs](#phase-10---completed-sub-task-102-_read_text_input-dedupe--helper-docs)
    - [Completion record](#completion-record-31)
  - [Phase 10 - Completed sub-task 10.3: `files.py` traversal-defense docs](#phase-10---completed-sub-task-103-filespy-traversal-defense-docs)
    - [Completion record](#completion-record-32)
  - [Phase 10 - Completed sub-task 10.4: `upload.py` extraction-path docs](#phase-10---completed-sub-task-104-uploadpy-extraction-path-docs)
    - [Completion record](#completion-record-33)
  - [Phase 10 - Completed sub-task 10.5: `tasks.py` thread-safety + `schemas.py` descriptions](#phase-10---completed-sub-task-105-taskspy-thread-safety--schemaspy-descriptions)
    - [Completion record](#completion-record-34)
  - [Phase 10 - Completed sub-task 10.6: guardrails + move + commit](#phase-10---completed-sub-task-106-guardrails--move--commit)
    - [Completion record](#completion-record-35)
  - [Phase 11 - Completed sub-task 11.1: `tests/conftest.py` fixture docs](#phase-11---completed-sub-task-111-testsconftestpy-fixture-docs)
    - [Completion record](#completion-record-36)
  - [Phase 11 - Completed sub-task 11.2: per-agent contract test audit](#phase-11---completed-sub-task-112-per-agent-contract-test-audit)
    - [Completion record](#completion-record-37)
  - [Phase 11 - Completed sub-task 11.3: `wip_testing/*.py` header comments](#phase-11---completed-sub-task-113-wip_testingpy-header-comments)
    - [Completion record](#completion-record-38)
  - [Phase 11 - Completed sub-task 11.4: `test_real_files.py` guard docs](#phase-11---completed-sub-task-114-test_real_filespy-guard-docs)
    - [Completion record](#completion-record-39)
  - [Phase 11 - Completed sub-task 11.5: file-top comments per test file](#phase-11---completed-sub-task-115-file-top-comments-per-test-file)
    - [Completion record](#completion-record-40)
  - [Phase 11 - Completed sub-task 11.6: guardrails + move + commit](#phase-11---completed-sub-task-116-guardrails--move--commit)
    - [Completion record](#completion-record-41)
  - [Phase 12 - Completed sub-task 12.1: `client.ts` error-parsing helpers](#phase-12---completed-sub-task-121-clientts-error-parsing-helpers)
    - [Completion record](#completion-record-42)
  - [Phase 12 - Completed sub-task 12.2: `hooks.ts` polling lifecycle docs](#phase-12---completed-sub-task-122-hooksts-polling-lifecycle-docs)
    - [Completion record](#completion-record-43)
  - [Phase 12 - Completed sub-task 12.3: `types.ts` FastAPI schema mappings](#phase-12---completed-sub-task-123-typests-fastapi-schema-mappings)
    - [Completion record](#completion-record-44)
  - [Phase 12 - Completed sub-task 12.4: `download.ts` URL docs](#phase-12---completed-sub-task-124-downloadts-url-docs)
    - [Completion record](#completion-record-45)
  - [Phase 12 - Completed sub-task 12.5: guardrails + move + commit](#phase-12---completed-sub-task-125-guardrails--move--commit)
    - [Completion record](#completion-record-46)
  - [Phase 13 - Completed sub-task 13.1: `coerce.ts` JSDoc + expanded one-liners](#phase-13---completed-sub-task-131-coercets-jsdoc--expanded-one-liners)
    - [Completion record](#completion-record-47)
  - [Phase 13 - Completed sub-task 13.2: `parts.tsx` renderer docs](#phase-13---completed-sub-task-132-partstsx-renderer-docs)
    - [Completion record](#completion-record-48)
  - [Phase 13 - Completed sub-task 13.3: `coerce.ts` module header](#phase-13---completed-sub-task-133-coercets-module-header)
    - [Completion record](#completion-record-49)
  - [Phase 13 - Completed sub-task 13.4: guardrails + move + commit](#phase-13---completed-sub-task-134-guardrails--move--commit)
    - [Completion record](#completion-record-50)
  - [Phase 14 - Completed sub-task 14.1: `ResultsTabView.tsx` tab-key comment](#phase-14---completed-sub-task-141-resultstabviewtsx-tab-key-comment)
    - [Completion record](#completion-record-51)
  - [Phase 14 - Completed sub-task 14.2: per-tab headers + consistent `coerce.ts` use](#phase-14---completed-sub-task-142-per-tab-headers--consistent-coercets-use)
    - [Completion record](#completion-record-52)
  - [Phase 14 - Completed sub-task 14.3: HTML-string trust boundary docs](#phase-14---completed-sub-task-143-html-string-trust-boundary-docs)
    - [Completion record](#completion-record-53)
  - [Phase 14 - Completed sub-task 14.4: extract repeated markup into `parts.tsx`](#phase-14---completed-sub-task-144-extract-repeated-markup-into-partstsx)
    - [Completion record](#completion-record-54)
  - [Phase 14 - Completed sub-task 14.5: guardrails + move + commit](#phase-14---completed-sub-task-145-guardrails--move--commit)
    - [Completion record](#completion-record-55)
  - [Phase 14 - Results tabs (8 components)  ✅ COMPLETED](#phase-14---results-tabs-8-components---completed)
    - [Completed sub-tasks](#completed-sub-tasks)
  - [Phase 15 - Completed sub-task 15.1: extract `isTaskActive(status)`](#phase-15---completed-sub-task-151-extract-istaskactivestatus)
    - [Completion record](#completion-record-56)
  - [Phase 15 - Completed sub-tasks 15.2-15.6: task labels, handleSubmit steps, form docs, guardrails](#phase-15---completed-sub-tasks-152-156-task-labels-handlesubmit-steps-form-docs-guardrails)
    - [Completion record](#completion-record-57)
  - [Phase 16 - Completed sub-tasks 16.1-16.4: Files page sections, state naming, header docs, guardrails](#phase-16---completed-sub-tasks-161-164-files-page-sections-state-naming-header-docs-guardrails)
    - [Completion record](#completion-record-58)
  - [Phase 17 - Completed sub-tasks 17.1-17.7: models page, App shell, theme, toast, entry, test helpers](#phase-17---completed-sub-tasks-171-177-models-page-app-shell-theme-toast-entry-test-helpers)
    - [Completion record](#completion-record-59)
  - [Phase 18 - Completed sub-tasks 18.1-18.4: frontend tests](#phase-18---completed-sub-tasks-181-184-frontend-tests)
    - [Completion record](#completion-record-60)
  - [Phase 19 - Completed sub-task 19.1: AGENTS.md file/architecture map + conventions](#phase-19---completed-sub-task-191-agentsmd-filearchitecture-map--conventions)
    - [Completion record](#completion-record-61)
  - [Phase 19 - Completed sub-task 19.2: README.md / ui/README.md quickstart accuracy](#phase-19---completed-sub-task-192-readmemd--uireadmemd-quickstart-accuracy)
    - [Completion record](#completion-record-62)
  - [Phase 19 - Completed sub-task 19.3: cross-check `docs/*.md` (8 guides) against code](#phase-19---completed-sub-task-193-cross-check-docsmd-8-guides-against-code)
    - [Completion record](#completion-record-63)
  - [Phase 19 - Completed sub-task 19.4: root scratch notes classified, completed notes added](#phase-19---completed-sub-task-194-root-scratch-notes-classified-completed-notes-added)
    - [Classification](#classification)
    - [Completion record](#completion-record-64)
  - [Phase 19 - Follow-up: archives moved to `scratch/` (user-approved)](#phase-19---follow-up-archives-moved-to-scratch-user-approved)
  - [Phase 19 - Completed sub-task 19.5: remove outdated "TODO/Phase X remains" lines](#phase-19---completed-sub-task-195-remove-outdated-todophase-x-remains-lines)
    - [Completion record](#completion-record-65)
  - [Phase 20 - Completed sub-task 20.1: backend final verification \& regression](#phase-20---completed-sub-task-201-backend-final-verification--regression)
    - [Completion record](#completion-record-66)
  - [Phase 20 - Completed sub-task 20.2: frontend final verification \& regression](#phase-20---completed-sub-task-202-frontend-final-verification--regression)
    - [Completion record](#completion-record-67)
  - [Phase 20 - Completed sub-task 20.3: manual smoke (CLI, web API, live E2E, UI)](#phase-20---completed-sub-task-203-manual-smoke-cli-web-api-live-e2e-ui)
    - [Completion record](#completion-record-68)
  - [Phase 20 - Completed sub-task 20.4: diff review + final commit](#phase-20---completed-sub-task-204-diff-review--final-commit)
    - [Completion record](#completion-record-69)
  - [Phase 20 - Completed sub-task 20.5: add progress log, archive the full plan](#phase-20---completed-sub-task-205-add-progress-log-archive-the-full-plan)
    - [Completion record](#completion-record-70)
  - [Phase 21 - Completed sub-task 21.1: root README \< 500 lines + 10-minute quickstart](#phase-21---completed-sub-task-211-root-readme--500-lines--10-minute-quickstart)
    - [Completion record](#completion-record-71)
  - [Phase 21 - Completed sub-task 21.2: detailed `docs/README.md`](#phase-21---completed-sub-task-212-detailed-docsreadmemd)
    - [Completion record](#completion-record-72)
  - [Phase 21 - Completed sub-task 21.3: ASCII diagrams → Mermaid](#phase-21---completed-sub-task-213-ascii-diagrams--mermaid)
    - [Completion record](#completion-record-73)
  - [Phase 21 - Completed sub-task 21.4: alphabetical prev/next links + docs/README.md index](#phase-21---completed-sub-task-214-alphabetical-prevnext-links--docsreadmemd-index)
    - [Completion record](#completion-record-74)
  - [Phase 21 - Completed sub-task 21.5: markdown docs audited and refreshed](#phase-21---completed-sub-task-215-markdown-docs-audited-and-refreshed)
    - [Completion record](#completion-record-75)
  - [Phase 21 - Completed sub-task 21.6: no markdown lint errors in any markdown file](#phase-21---completed-sub-task-216-no-markdown-lint-errors-in-any-markdown-file)
    - [Completion record](#completion-record-76)
- [Archive: Full Simplification Plan (from simple.md)](#archive-full-simplification-plan-from-simplemd)
- [Simplification Plan: Inspect \& Simplify Every File, Method, Module](#simplification-plan-inspect--simplify-every-file-method-module)
  - [Purpose](#purpose)
  - [Guiding Rules](#guiding-rules)
    - [Simplification rules (how we change code)](#simplification-rules-how-we-change-code)
    - [Documentation rules (how we improve docs)](#documentation-rules-how-we-improve-docs)
    - [Guardrails (every phase)](#guardrails-every-phase)
    - [Per-file checklist (use in every phase)](#per-file-checklist-use-in-every-phase)
  - [File Inventory (what we are covering)](#file-inventory-what-we-are-covering)
    - [Backend - core pipeline (`client/`)](#backend---core-pipeline-client)
    - [Backend - orchestration, CLI, config](#backend---orchestration-cli-config)
    - [Backend - web API (`app/`)](#backend---web-api-app)
    - [Backend - tests \& scratch](#backend---tests--scratch)
    - [Frontend (`ui/src/`)](#frontend-uisrc)
    - [Docs](#docs)
  - [Phase 0 - Baseline snapshot \& conventions](#phase-0---baseline-snapshot--conventions)
  - [Part A - Backend (Python)](#part-a---backend-python)
  - [Phase 1 - Foundation: config, logging, errors, LLM clients, JSON utils  ✅ COMPLETED](#phase-1---foundation-config-logging-errors-llm-clients-json-utils---completed-1)
  - [Phase 2 - Pydantic models \& coercion  ✅ COMPLETED](#phase-2---pydantic-models--coercion---completed-1)
  - [Phase 3 - Parsing agents \& the format detector  ✅ COMPLETED](#phase-3---parsing-agents--the-format-detector---completed-1)
  - [Phase 4 - LLM-only agents: Gap Analysis, ATS Compliance, Tone Polishing + shared validation cleanup  ✅ COMPLETED](#phase-4---llm-only-agents-gap-analysis-ats-compliance-tone-polishing--shared-validation-cleanup---completed-1)
  - [Phase 5 - Resume Rewrite agent + post-validation  ✅ COMPLETED](#phase-5---resume-rewrite-agent--post-validation---completed-1)
  - [Phase 6 - Cover Letter agent (largest file)  ✅ COMPLETED](#phase-6---cover-letter-agent-largest-file---completed-1)
  - [Phase 7 - Renderer, templates, formatter  ✅ COMPLETED](#phase-7---renderer-templates-formatter---completed-1)
  - [Phase 8 - Skill taxonomy \& normalization  ✅ COMPLETED](#phase-8---skill-taxonomy--normalization---completed-1)
  - [Phase 9 - Pipeline orchestration + CLI  ✅ COMPLETED](#phase-9---pipeline-orchestration--cli---completed)
  - [Phase 10 - Web API layer  ✅ COMPLETED](#phase-10---web-api-layer---completed)
  - [Phase 11 - Backend tests \& scratch scripts  ✅ COMPLETED](#phase-11---backend-tests--scratch-scripts---completed)
  - [Part B - Frontend (React / TypeScript)](#part-b---frontend-react--typescript)
  - [Phase 12 - API layer: client, hooks, types, download  ✅ COMPLETED](#phase-12---api-layer-client-hooks-types-download---completed)
  - [Phase 13 - Result data coercion + shared result parts  ✅ COMPLETED](#phase-13---result-data-coercion--shared-result-parts---completed)
  - [Phase 14 - Results tabs (8 components)  ✅ COMPLETED](#phase-14---results-tabs-8-components---completed-1)
  - [Phase 15 - Run page \& form helpers](#phase-15---run-page--form-helpers)
  - [Phase 16 - Files page](#phase-16---files-page)
  - [Phase 17 - Models page, App shell, theme, toast, entry](#phase-17---models-page-app-shell-theme-toast-entry)
  - [Phase 18 - Frontend tests](#phase-18---frontend-tests)
  - [Part C - Closing](#part-c---closing)
  - [Phase 19 - Repo-wide documentation consolidation](#phase-19---repo-wide-documentation-consolidation)
  - [Phase 20 - Final verification \& regression](#phase-20---final-verification--regression)
  - [Work Breakdown Checklists (Phases 4-21)](#work-breakdown-checklists-phases-4-21)
    - [Phase 4 - LLM-only agents + shared validation cleanup ✅ COMPLETED](#phase-4---llm-only-agents--shared-validation-cleanup--completed)
    - [Phase 5 - Resume Rewrite agent + post-validation ✅ COMPLETED](#phase-5---resume-rewrite-agent--post-validation--completed)
    - [Phase 6 - Cover Letter agent (largest file) ✅ COMPLETED](#phase-6---cover-letter-agent-largest-file--completed)
    - [Phase 7 - Renderer, templates, formatter ✅ COMPLETED](#phase-7---renderer-templates-formatter--completed)
    - [Phase 8 - Skill taxonomy \& normalization ✅ COMPLETED](#phase-8---skill-taxonomy--normalization--completed)
    ...
    - [Phase 10 - Web API layer ✅ COMPLETED](#phase-10---web-api-layer--completed)
    - [Phase 11 - Backend tests \& scratch scripts ✅ COMPLETED](#phase-11---backend-tests--scratch-scripts--completed)
    - [Phase 12 - Frontend API layer ✅ COMPLETED](#phase-12---frontend-api-layer--completed)
    - [Phase 13 - Result data coercion + shared result parts ✅ COMPLETED](#phase-13---result-data-coercion--shared-result-parts--completed)
    - [Phase 14 - Results tabs (8 components) ✅ COMPLETED](#phase-14---results-tabs-8-components--completed)
    - [Phase 15 - Run page \& form helpers ✅ COMPLETED](#phase-15---run-page--form-helpers--completed)
    - [Phase 16 - Files page ✅ COMPLETED](#phase-16---files-page--completed)
    - [Phase 17 - Models page, App shell, theme, toast, entry ✅ COMPLETED](#phase-17---models-page-app-shell-theme-toast-entry--completed)
    - [Phase 18 - Frontend tests ✅ COMPLETED](#phase-18---frontend-tests--completed)
    - [Phase 19 - Repo-wide documentation consolidation ✅ COMPLETED](#phase-19---repo-wide-documentation-consolidation--completed)
    - [Phase 20 - Final verification \& regression](#phase-20---final-verification--regression-1)
    - [Phase 21 - Documentation Cleanup](#phase-21---documentation-cleanup)
  - [Phase 23 - Completed sub-task 23.1: cover letter DOCX/PDF output](#phase-23---completed-sub-task-231-cover-letter-docxpdf-output)
    - [What was wrong](#what-was-wrong)
    - [Changes](#changes)
    - [Verification results](#verification-results)
  - [Phase 23 - Completed sub-task 23.2: markdown line breaks in generated files](#phase-23---completed-sub-task-232-markdown-line-breaks-in-generated-files)
    - [What was wrong](#what-was-wrong-1)
    - [Changes](#changes-1)
    - [Verification results](#verification-results-1)
  - [Phase 23 - Completed sub-task 23.3: generate all three resume layout formats](#phase-23---completed-sub-task-233-generate-all-three-resume-layout-formats)
    - [Design (user clarification: "Both selector AND all-three option")](#design-user-clarification-both-selector-and-all-three-option)
    - [Backend](#backend)
    - [Frontend](#frontend)
    - [Tests](#tests)
    - [Verification results](#verification-results-2)
  - [Phase 23 - Completed sub-task 23.4: cover letter closing salutation no longer repeated](#phase-23---completed-sub-task-234-cover-letter-closing-salutation-no-longer-repeated)
    - [Root cause](#root-cause)
    - [Fix](#fix)
    - [Tests](#tests-1)
    - [Verification results](#verification-results-3)
  - [Phase 22 - Model editing (SQLite overrides + Models page editing) ✅ COMPLETED](#phase-22---model-editing-sqlite-overrides--models-page-editing--completed)
    - [Design](#design)
    - [Backend](#backend-1)
    - [Frontend](#frontend-1)
    - [Verification results](#verification-results-4)
