...
- [Frontend Implementation — Completed Tasks](#frontend-implementation--completed-tasks)
  - [Overview](#overview)
  - [Completed](#completed)
    - [1.1 Add a static-mount helper in `app/main.py` — DONE](#11-add-a-static-mount-helper-in-appmainpy--done)
      - [Verification](#verification)
    - [1.2 Wire the mount in `app/main.py`, guarded by build presence — DONE](#12-wire-the-mount-in-appmainpy-guarded-by-build-presence--done)
      - [Verification 1.2](#verification-12)
    - [1.3 Add a backend test for the SPA fallback — DONE](#13-add-a-backend-test-for-the-spa-fallback--done)
      - [Verification 1.3](#verification-13)
    - [2.1 Create the Vite project — DONE](#21-create-the-vite-project--done)
      - [Verification 2.1](#verification-21)
    - [2.2 Install dependencies — DONE](#22-install-dependencies--done)
      - [Verification 2.2](#verification-22)
    - [2.3 Gitignore + prune scaffold boilerplate — DONE](#23-gitignore--prune-scaffold-boilerplate--done)
      - [Verification 2.3](#verification-23)
    - [2.4 Wire PrimeReact themes (light + dark) — DONE](#24-wire-primereact-themes-light--dark--done)
      - [Verification 2.4](#verification-24)
    - [2.5 Theme state — default to system, allow manual override — DONE](#25-theme-state--default-to-system-allow-manual-override--done)
      - [Verification 2.5](#verification-25)
    - [3.1 Add the `/api` dev proxy — DONE](#31-add-the-api-dev-proxy--done)
      - [Verification 3.1](#verification-31)
    - [4.1 `src/api/types.ts` — backend schema types — DONE](#41-srcapitypests--backend-schema-types--done)
      - [Verification 4.1](#verification-41)
    - [4.2 `src/api/client.ts` — fetch wrappers — DONE](#42-srcapiclientts--fetch-wrappers--done)
      - [Verification 4.2](#verification-42)
    - [4.3 `src/api/download.ts` — download URL helpers — DONE](#43-srcapidownloadts--download-url-helpers--done)
      - [Verification 4.3](#verification-43)
    - [4.4 `src/api/hooks.ts` — React Query hooks — DONE](#44-srcapihooksts--react-query-hooks--done)
      - [Verification 4.4](#verification-44)
    - [5.1 App shell — `src/App.tsx` — DONE](#51-app-shell--srcapptsx--done)
      - [Verification 5.1](#verification-51)
    - [5.2 Run page — form (paste or upload) — DONE](#52-run-page--form-paste-or-upload--done)
      - [Verification 5.2](#verification-52)
    - [5.3 Run page — async status — DONE](#53-run-page--async-status--done)
      - [Verification 5.3](#verification-53)
    - [5.4.1 Results container + Parsed JD tab — DONE](#541-results-container--parsed-jd-tab--done)
      - [Verification 5.4.1](#verification-541)
    - [5.4.2 Parsed Resume tab — DONE](#542-parsed-resume-tab--done)
      - [Verification 5.4.2](#verification-542)
    - [5.4.3 Gap Analysis tab — DONE](#543-gap-analysis-tab--done)
      - [Verification 5.4.3](#verification-543)
    - [5.4.4 Rewritten Resume tab — DONE](#544-rewritten-resume-tab--done)
      - [Verification 5.4.4](#verification-544)
    - [5.4.5 ATS tab — DONE](#545-ats-tab--done)
      - [Verification 5.4.5](#verification-545)
    - [5.4.6 Polished tab — DONE](#546-polished-tab--done)
      - [Verification 5.4.6](#verification-546)
    - [5.4.7 Cover Letter tab — DONE](#547-cover-letter-tab--done)
      - [Verification 5.4.7](#verification-547)
    - [5.4 Run page — results `TabView` — DONE](#54-run-page--results-tabview--done)
      - [Verification 5.4](#verification-54)
    - [5.5 Run page — downloads row — DONE](#55-run-page--downloads-row--done)
      - [Verification 5.5](#verification-55)
    - [5.6 Files page — DONE](#56-files-page--done)
      - [Verification 5.6](#verification-56)
    - [5.7 Models page — DONE](#57-models-page--done)
      - [Verification 5.7](#verification-57)
    - [6.1 Configure Vitest — DONE](#61-configure-vitest--done)
      - [Verification 6.1](#verification-61)
    - [6.2 Test the API client (`src/api/client.ts`) — DONE](#62-test-the-api-client-srcapiclientts--done)
      - [Verification 6.2](#verification-62)
    - [6.3 Test React Query hooks (`src/api/hooks.ts`) — DONE](#63-test-react-query-hooks-srcapihooksts--done)
      - [Verification 6.3](#verification-63)
    - [6.4 Test the theme hook (`useTheme`) — DONE](#64-test-the-theme-hook-usetheme--done)
      - [Verification 6.4](#verification-64)
    - [6.5 Test components — DONE](#65-test-components--done)
      - [Verification 6.5](#verification-65)
    - [6.6 Run the full suite — DONE](#66-run-the-full-suite--done)
      - [Verification 6.6](#verification-66)
    - [7.1 Backend checks — DONE](#71-backend-checks--done)
      - [Verification 7.1](#verification-71)
    - [7.2 Frontend checks — DONE](#72-frontend-checks--done)
      - [Verification 7.2](#verification-72)
    - [8.1 Update `AGENTS.md` — DONE](#81-update-agentsmd--done)
      - [Verification 8.1](#verification-81)
